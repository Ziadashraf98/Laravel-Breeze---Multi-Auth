    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index.html"><img src="{{asset('admin/assets/img/brand/logo.png')}}" class="logo-1" alt="logo"></a>
                <a href="index.html"><img src="{{asset('admin/assets/img/brand/logo-white.png')}}" class="dark-logo-1" alt="logo"></a>
                <a href="index.html"><img src="{{asset('admin/assets/img/brand/favicon.png')}}" class="logo-2" alt="logo"></a>
                <a href="index.html"><img src="{{asset('admin/assets/img/brand/favicon.png')}}" class="dark-logo-2" alt="logo"></a>
            </div>
        ...
        <div class="main-header-right" >
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt="" style="background: white" src="{{asset('admin/assets/img/faces/admin.png')}}"></a>
                    <div class="dropdown-menu">
