								...
								<div class="row">
									<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
										<div class="card-sigin">
											<div class="mb-5 d-flex mx-auto"> <a href="{{route('admin.registerForm')}}" class="mx-auto d-flex"><img src="{{asset('admin/assets/img/brand/favicon.png')}}" class="sign-favicon ht-40 mx-auto" alt="logo"><h1 class="main-logo1 ml-1 mr-0 my-auto tx-28 text-white ml-2">Register<span></span></h1></a></div>
